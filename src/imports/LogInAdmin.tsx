...
export default function LogInAdmin() {
  return (
    <div className="bg-[#f4f4f4] relative size-full" data-name="LOG IN - ADMIN">
      ...
      <div className="absolute bg-[#1a1851] h-[39px] left-[98px] rounded-[8px] top-[345px] w-[164px]" />
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] left-[139px] not-italic text-[#929292] text-[14px] text-nowrap top-[462px] whitespace-pre">staff@ustp.edu.ph</p>
      <p className="absolute font-['Poppins:Bold',sans-serif] leading-[normal] left-[179.5px] not-italic text-[14px] text-center text-white top-[354px] translate-x-[-50%] w-[55px]">Admin</p>
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] left-[344.5px] not-italic text-[14px] text-black text-center top-[354px] translate-x-[-50%] w-[63px]">Student</p>
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] left-[261.5px] not-italic text-[#1a1851] text-[14px] text-center text-nowrap top-[743px] translate-x-[-50%] whitespace-pre">
